...
/**
 * @author 冷秋飞枫 qq：425018553 http编程 助手
 * {@link HttpClientUtil}
 */
@Deprecated
public class Httphandler {
    static private String str = null;
    static public String QEncode = "gbk";
    static public String BEncode = "gbk";
     ...
     * @throws IOException
     */
    static public String myhttpGet(String url, Map<String, String> mapdata,
                                   String qencode, String bencode) throws ClientProtocolException,
            IOException {
        str = url;
        QEncode = qencode;
        BEncode = bencode;
        ...
        if (mapdata != null) {
            ...
            for (Iterator<Map.Entry<String, String>> it = set.iterator(); it
                ...
                sbu.append(entry.getKey() + "="
                        + URLEncoder.encode(entry.getValue(), QEncode) + "&");
     ...
     * @throws IOException
     */
    static public String myhttpPost(String url, Map<String, String> mapdata,
                                    String encode, String bencode) throws ClientProtocolException,
            IOException {
        QEncode = encode;
        BEncode = bencode;
        HttpClient client = new DefaultHttpClient();
     ...
     * @throws IOException
     */
    static String requseturl(HttpResponse response)
